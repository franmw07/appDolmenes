...
mapboxgl.accessToken = 'pk.eyJ1IjoiZnJhbm13MDciLCJhIjoiY2t5b2VhZnJrMWp0eDJvdWZnaWVkdzFidyJ9.OfL1GI7lLtquvIkqLzatfg';
...
for (const marker of iconJson.items) {
    ...
    // popup
    const popup = new mapboxgl.Popup({ offset: 25 }).setHTML(`<strong>${title}:</strong><br><p>${text}</p>`);
  ...
  updateCards(card, data) {
    ...
    if (data.zIndex || data.zIndex == 0) {
      if (data.zIndex == 0) {
        ...
        let src =
          document.querySelector(".highlight>img") ||
          document.querySelector(".highlight>model-viewer");
        if (src === document.querySelector(".highlight>img")) {
          ...
          switch (newSrc) {
            case "../../media/02_Jose_Arana.jpeg":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Jose Arana 02</li>
            ...
            case "../../media/15_Jose_Arana.jpeg":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Jose Arana 15</li>
                                                                        <li class="fs-4">Ubicación</li>
                                                                        <li class="fs-4">Fecha</li>
                                                                        <li class="fs-4">...</li>`;
              break;
            case "../../media/dolmen-2.jpg":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Dolmen-2</li>
                                                                        <li class="fs-4">Ubicación</li>
                                                                        <li class="fs-4">Fecha</li>
                                                                        <li class="fs-4">...</li>`;
              break;
            case "../../media/Laskorain_HH3_1Solairua_EsperientziaTxokoa1_11.jpeg":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Laskorain HH3</li>
                                                                        <li class="fs-4">Ubicación</li>
                                                                        <li class="fs-4">Fecha</li>
                                                                        <li class="fs-4">...</li>`;
              break;
            case "../../media/Laskorain_HH4_1Solairua_Zentzumen_Txokoa1_29.jpeg":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Laskorain HH4</li>
                                                                        <li class="fs-4">Ubicación</li>
                                                                        <li class="fs-4">Fecha</li>
                                                                        <li class="fs-4">...</li>`;
              break;
          ...
          switch (newSrc) {
            case "../../media/Barca_01.glb":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Barca</li>
            ...
            case "../../media/Capitan America (1).glb":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Capitan América</li>
                                                                          <li class="fs-4">Tamaño</li>
                                                                          <li class="fs-4">Fecha</li>
                                                                          <li class="fs-4">Material</li>
                                                                          <li class="fs-4">Utilidad</li>
            ...
            case "../../media/GLB_Arbol_01.glb":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Arbol</li>
                                                                          <li class="fs-4">Tamaño</li>
                                                                          <li class="fs-4">Fecha</li>
                                                                          <li class="fs-4">Material</li>
                                                                          <li class="fs-4">Utilidad</li>
            ...
            case "../../media/GLB_Coche_03.glb":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Coche</li>
                                                                          <li class="fs-4">Tamaño</li>
                                                                          <li class="fs-4">Fecha</li>
                                                                          <li class="fs-4">Material</li>
                                                                          <li class="fs-4">Utilidad</li>
            ...
            case "../../media/GLB_Jaguar.glb":
              document.querySelector(
                ".container_text_maps"
              ).innerHTML = `<li class="fs-4">Nombre Jaguar</li>
                                                                          <li class="fs-4">Tamaño</li>
                                                                          <li class="fs-4">Fecha</li>
                                                                          <li class="fs-4">Material</li>
                                                                          <li class="fs-4">Utilidad</li>
